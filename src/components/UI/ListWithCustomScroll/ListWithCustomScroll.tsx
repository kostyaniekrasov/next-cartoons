...
const ListWithCustomScroll = ({ playlist, ChangeVideo, currentId }: Props) => {
  return playlist ? (
    <List
      sx={{
        height: {
          ...
          <React.Fragment key={video.id}>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="secondaryText" className="no-hover-effect">
                  {getFirstParagraph(video.snippet.description)}
                </Typography>
              </Box>
            </ListItem>
